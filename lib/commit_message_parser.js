...
function Pair(pair) {
	function equals(otherPair) {
		// for(var x in otherPair) {
		// 	console.log("other has: " + x + " " + otherPair[x]);
		// }
		// console.log("other:" + otherPair.person1 + " " + otherPair.person2);
		// console.log("pair:" + pair.person1 + " " + pair.person2);
